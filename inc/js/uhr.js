...
var thistime = Wochentag[TagInWoche] + ", " + Tag +"." + Monat[Jahresmonat] + "."+ Jahr +"<br />" + hours + ":" + minutes + ":" + seconds + " Uhr"
...
function clockon() {
  ...
  var Wochentag = new Array("Sonntag", "Montag", "Dienstag", "Mittwoch",
	...
	if (seconds < 10) {seconds="0"+seconds}
	if (Jahr<2000) Jahr=Jahr+1900;
	thistime = Wochentag[TagInWoche] + ", " + Tag +"." + Monat[Jahresmonat] + "."+ Jahr +"<br />" + hours + ":" + minutes + ":" + seconds + " Uhr"
